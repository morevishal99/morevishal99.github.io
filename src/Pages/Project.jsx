    ...
    return (
        <Box mt={{ sm: '20%', md: '10%', lg: '5%' }} id="projects">
            ...
            <Box  w={"80%"} display={{ base: "column", sm: "column", lg: "grid" }} gridTemplateColumns="repeat(2,1fr)" m={"auto"} mt="50px" gap={20}>
                {/* one */}
                <Text marginTop={"15px"} padding={"15px"} className="project-card" borderRadius='20px' right boxShadow={" rgba(0, 0, 0, 0.35) 0px 5px 15px;"}>
                ...
                {/* two */}
                <Text marginTop={"15px"} padding={"15px"}borderRadius='20px' boxShadow={" rgba(0, 0, 0, 0.35) 0px 5px 15px;"}
                ...
                {/* three */}
                <Text marginTop={"15px"} padding={"15px"}borderRadius='20px' className="project-card" left boxShadow={" rgba(0, 0, 0, 0.35) 0px 5px 15px;"}>
                    <Box style={Theme === 'light' ? light : dark} w={"100%"} borderRadius='lg' overflow='hidden' backgroundColor={"white"} mb={10} >
                ...
                {/* four */}
                <Text marginTop={"15px"} padding={"15px"}borderRadius='20px' className="project-card" right boxShadow={" rgba(0, 0, 0, 0.35) 0px 5px 15px;"}>
                    <Box style={Theme === 'light' ? light : dark} w={"100%"} borderRadius='lg' overflow='hidden' backgroundColor={"white"} mb={10} >
